...
You will be given:
- A candidate summary (skills, experience, seniority)
- A job description
- A deterministic match score (0-100) alreadt computed from skills coverage, experience, and seniority.
...
5. fit_summary must be exactly 2 sentences. It must be consistent with the score — do not write a glowing summary for a low score or a negative one for a high score.
6. If the score is below 40, weaknesses should outweigh strengths in tone.
...
Return JSON matching this schema exactly:
{
  "strengths": ["...", "...", "..."],
  "weaknesses": ["...", "..."],
  "fit_summary": "Sentence one. Sentence two."
}

"""

FIT_REASONING_USER_PROMPT = """
Deterministic match score: {score}/100
