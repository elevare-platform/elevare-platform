from app.core.cv_pipeline.layer4_deterministic import PHONE_PATTERNS
from app.core.cv_pipeline.layer4_deterministic import EMAIL_PATTERN
import re
...
from app.core.cv_pipeline.models import CVExtractionResult, WorkEntry, EducationEntry
